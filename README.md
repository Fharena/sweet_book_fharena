...
Triplogue는 여행 사진을 업로드하면 촬영 시간과 위치 정보를 읽어 날짜별, 장소별로 자동 정리하고, 이를 Sweetbook 포토북 주문 흐름으로 연결하는 여행 포토북 웹앱입니다.
...
- `/ops/webhooks`: Sweetbook 웹훅 등록, 테스트 전송, delivery 이력 조회
